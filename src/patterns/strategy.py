...
# class Pistol(Gun):
#     def __init__(self):
#         self.clipper_size = 10
#         self.auto = None
    
#     def shoot(self):
#         print(f"Shooting with pistol {Pistol.__class__}")


# class Ak(Gun):
#     def __init__(self):
#         self.clipper_size = 30
#         self.auto = True
    
#     def shoot(self):
#         print("Shootring with AK {Ak.__class__}")
